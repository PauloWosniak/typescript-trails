...
layout: ''
head:
  description: About page of Typescript Trails website
  image: ''
---

# About

This website documents TypeScript learning experiences, focusing on practical knowledge gained through mentorship and hands-on coding.

The goal is simple: share clear, useful information about TypeScript for developers looking to improve their skills.

Expect straightforward explanations, code examples, and insights into TypeScript's key concepts.
...
::button-link{href="https://github.com/PauloWosniak/typescript-trails"}
Typescript Trails on GitHub
::
